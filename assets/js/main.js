...
const skills = [
  ...
  { name: "Business Analysis", progress: "85" },
  { name: "Docker", progress: "50" },
  { name: "Odoo.sh", progress: "85" },
  { name: "Aws / Digital Ocean / Google Cloud", progress: "80" },
  { name: "Business Flow", progress: "70" },
  { name: "MRP Workflow", progress: "80" },
  { name: "Web Design", progress: "60" },
  { name: "JavaScript", progress: "50" },
  { name: "Css", progress: "70" },
  { name: "Accounting Localize", progress: "80" },
  { name: "Server Admin", progress: "80" },
];
